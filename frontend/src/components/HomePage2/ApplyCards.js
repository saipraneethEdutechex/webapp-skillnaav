    ...
    <div className="relative bg-white rounded-lg shadow-lg max-w-full mx-auto p-4 sm:p-6 lg:p-8 xl:p-12 overflow-auto">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-600 leading-relaxed">
          ...
          <br /><br />
          Corrupti pariatur eum eum. Velit cupiditate rerum velit debitis. Sequi ducimus
          ipsum facilis voluptas. Dignissimos dolores aut voluptas. Possimus magni
          voluptas est. Animi impedit aut.
          <br /><br />
          Nihil ipsam voluptas. Voluptates omnis et. Dolores modi temporibus quidem est
          porro culpa. Exercitationem qui voluptatem repudiandae voluptate et dolores.
          Est omnis ut et est cumque at provident eos sint. Et qui aut recusandae quam
          dolor explicabo.
        </p>
      </div>
